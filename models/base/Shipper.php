 ...
 * @property \app\models\Shipment[] $shipments
...
abstract class Shipper extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(\app\models\Certificate::className(), ['shipper_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\app\models\Shipment::className(), ['shipper_id' => 'id']);
    }
